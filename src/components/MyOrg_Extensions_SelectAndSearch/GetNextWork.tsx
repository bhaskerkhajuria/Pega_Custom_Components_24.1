...
// interface for props
interface MyOrgExtensionsSelectAndSearchWorkProps extends PConnFieldProps {
  // If any, enter additional props that only exist on TextInput here
  variant: any;

}

export default function GetNextWork(props: MyOrgExtensionsSelectAndSearchWorkProps) {
